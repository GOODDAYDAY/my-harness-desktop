...
// core/application。pi 路读 ModelsStore(~/.pi/agent/models.json),dsh 路经 DshModelSource
// 接口读 cordis.yml(实现落 client/dsh,依赖倒置)。两路各自在「来源」处打 kernel 标。
//
// application 不 import electron/具体存储:dsh 侧的 cordis.yml 读取经 DshModelSource 接口注入。
...
export class ModelCatalog {
  constructor(
    ...
    private readonly dsh: DshModelSource,
  ) {}
