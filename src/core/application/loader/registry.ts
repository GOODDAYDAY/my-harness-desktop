...
export class PluginRegistry {
  ...
  private readonly arraySlots: { slot: "settings" | "sidePanel" | "sidebar" | "mainView" | "titlebar" | "fileActions" | "messageActions" | "systemPrompts"; reg: ArraySlot<unknown> }[] = [
  ...
  /** 列 messageActions 槽所有贡献项(timeline 等消费方渲染按钮用,按 order 升序,缺省 100)。 */
