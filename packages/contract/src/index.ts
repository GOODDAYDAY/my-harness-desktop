...
export type {
  ...
  MainViewContribution, LanguageContribution, MessageRendererContribution, FileActionContribution, MessageActionContribution, SlotName, PluginContributes, PluginManifest,
